    ...
    <section className="mx-auto flex w-full flex-col items-center justify-center gap-12 px-10 md:gap-12 md:px-24 lg:max-w-screen-xl lg:gap-12 xl:max-w-screen-2xl">
      ...
      {testimonials.length > 0 && (
        <article className="flex flex-col items-center justify-between gap-5 md:flex-row md:gap-24 lg:gap-32">
          <div className="relative h-52 w-52 overflow-hidden rounded-t-full md:h-[380px] md:min-w-[300px] lg:h-[400px] lg:min-w-[352px]">
            {isLoading ? (
          ...
          <figure className="flex max-w-screen-md flex-col items-center justify-center gap-4 text-xs md:items-start md:gap-10 md:text-left md:text-sm lg:text-base">
            <FaQuoteLeft size={40} className="hidden md:block" />
            <blockquote className="text-center font-workSans font-normal md:text-left lg:leading-[2.5rem]">
